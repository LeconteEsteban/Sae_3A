...
CREATE TABLE User_Book_Notation (
    ...
    CONSTRAINT fk_review FOREIGN KEY (review_id) REFERENCES User_Book_Review(review_id)
    CONSTRAINT fk_read FOREIGN KEY (read_id) REFERENCES User_Book_Read(read_id)
);
